...
export declare class LabPracticeSession {
  ...
  readonly LabPracticeSessionOutputs?: (LabPracticeSessionOutput | null)[];
...
export declare class LabPracticeOutput {
  ...
  readonly updatedBy?: string;
  readonly createdBy?: string;
  readonly LabPractice?: LabPracticeSessionOutput;
  readonly labpracticeID?: string;
...
export declare class LabPracticeSessionOutput {
  ...
  readonly LabPracticeOutput?: LabPracticeOutput;
  readonly LabPracticeSession?: LabPracticeSessionCommand;
